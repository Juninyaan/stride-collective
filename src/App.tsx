...
const classes = [
  {
    ...
    intensity: 'High',
    description:
      'A fast-paced conditioning session built around intervals, bodyweight circuits, and coach-led pacing. Best for clients who want a structured sweat and a strong start to the day.',
    slots: 12,
  ...
  },
  {
    ...
    location: 'Hulhumale Open Ground',
    intensity: 'Moderate',
    description:
      'A skill-focused class combining functional strength movements with deliberate technique coaching. Ideal for beginners building a foundation and intermediate clients refining movement quality.',
    slots: 10,
  ...
  },
  {
    ...
    intensity: 'High',
    description:
      'A high-energy evening session designed to close out the workday with purpose. Circuit-based, coach-led, and programmed to push work capacity while staying technically sound.',
    slots: 14,
  ...
  },
  {
    ...
    description:
      'A weekend recovery and maintenance class focusing on core stability, mobility flow, and controlled breathwork. A strong complement to the higher-intensity weekday sessions.',
    slots: 12,
    image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Private PT — Gym Floor',
    type: 'One-on-One · Partner Gym',
    schedule: 'By appointment — 7 days',
    location: 'Partner gym, Male or Hulhumale',
    intensity: 'Tailored',
    description:
      'A personalised session with a dedicated Stride coach inside one of our partner facilities. Programming is built around the individual client and adjusted weekly based on progress.',
    slots: null,
    image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Corporate Group Activation',
    type: 'Group · Private',
    schedule: 'Flexible — minimum 8 participants',
    location: 'Client venue or nominated outdoor space',
    intensity: 'Tailored',
    description:
      'A branded fitness session delivered on-site for companies, residences, and institutions. Format and intensity scaled to the group and suitable for a wide range of abilities.',
    slots: null,
...
const trainers = [
  {
    name: 'Aisha Riyas',
    badge: 'Head Coach',
    role: 'Lead Coach · Group Class Director',
    bio: 'Aisha leads the collective class experience with precision, energy, and a polished client standard she has refined across hundreds of coached sessions in Male and Hulhumale.\n\nHer sessions are driven by strong programming, clear coaching cues, and a community atmosphere built on consistency. She believes showing up with intention every week builds not just fitness, but confidence and long-term adherence.\n\nWhether you are starting fresh or returning after a break, Aisha will meet you where you are and help you build from there.',
    focus: ['Body recomposition', 'Beginner strength', 'Habit coaching'],
    photo: 'https://images.unsplash.com/photo-1548690312-e3b507d8c110?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Shifan Latheef',
    badge: 'Performance Coach',
    role: 'Performance Coach · Conditioning Specialist',
    bio: 'Shifan specialises in strength and conditioning progressions for clients who want sharper movement quality, stronger work capacity, and more athletic training outcomes.\n\nHis approach combines structural programming with technical coaching, ensuring each session builds toward a measurable outcome rather than just a hard workout.\n\nClients working with Shifan develop better movement patterns, stronger performance benchmarks, and a training system they can maintain across a season.',
    focus: ['Conditioning', 'Functional strength', 'Sports prep'],
    photo: 'https://images.unsplash.com/photo-1567013127542-490d757e51fc?auto=format&fit=crop&w=900&q=80',
  },
  {
    name: 'Mariyam Nazla',
    badge: 'PT Specialist',
    role: 'Personal Training Specialist · Mobility Coach',
    bio: 'Mariyam delivers a higher-touch personal training service for clients who want efficient programming, schedule flexibility, and consistent coach oversight across every phase of their plan.\n\nHer sessions integrate mobility, lifestyle habits, and progressive strength work into a single coherent system designed around how clients actually live — not just how they train.\n\nIf your schedule is demanding and your goals are real, Mariyam is the coach who makes progress feel both achievable and sustainable.',
    focus: ['Personal training', 'Mobility', 'Lifestyle balance'],
